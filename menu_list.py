...
def add_project_menu():
    ...
    if choice == "1":
        clear_terminal()
        projects.ProgrammingProject.add_project_programming(project_lists.programming_projects)
    elif choice == "2":
        clear_terminal()
        projects.EverydayProject.add_project_everyday(project_lists.everyday_projects)
    elif choice == "3":
        clear_terminal()
        start_menu()
    elif choice == "4":
